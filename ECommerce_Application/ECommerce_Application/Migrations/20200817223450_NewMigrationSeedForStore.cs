...
{
    public partial class NewMigrationSeedForStore : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 2, "Staffordshire Terrier", "Brindle", "Absolutely is an attention hog. He will chill and hang out with you all day and love life. He enjoys the outdoors from sunbathing in the backyard to going for long walks. Is very obedient and will let you clean his ears, brush ", "Rampage", 200m, null, "Super Love" },
                    { 2, 4, "Poodle", "White", "Loves ", "Snowball", 200m, null, "Super Love" },
                    { 3, 7, "Golden Doodle", "Golden", "Her thick hips won't stop her from dragging you across the concrete to catch a squirrel", "Whiskey", 2000m, null, "Fly" },
