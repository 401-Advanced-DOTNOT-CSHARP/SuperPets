        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 4, 6, "Labradoodle", "Poodles", "black", "Fastest dog in the world. She's beat Usain Bolt... Twice. ", "https://superpetpicturestorage.blob.core.windows.net/productimages/rye.jpeg", false, "Rye", 90000000m, 1, null, "Super speed" },
                    { 5, 3, "Dog", "Poodles", "Brown and White", "Will knock anything on your desk onto the floor. Can also poop in toilet. ", "https://superpetpicturestorage.blob.core.windows.net/productimages/backup.jpeg", false, "Snowball", 40000m, 1, null, "Personality" },
                    ...
                    { 7, 99, "Dog", "Bully", "Grey", "Disrupts Zoom meetings. Can order Starbucks on occassion.", "https://superpetpicturestorage.blob.core.windows.net/productimages/Josie", false, "Josie", 6000000m, 1, null, "Ordering coffee" },
                    { 8, 8, "Dog", "Bully", "Orangeish", "As if a dog wasn't enough, this guy comes with laser eyes. ", "https://superpetpicturestorage.blob.core.windows.net/productimages/chubbs.jpeg", false, "Chubbs", 1000000m, 1, null, "Laser Eyes" },
                    { 9, 15, "Dog", "Bully", "Orange and White", "An engineer who dabbles in explosives.", "https://superpetpicturestorage.blob.core.windows.net/productimages/Peanut.jpeg", false, "Peanut", 500000m, 1, null, "Super Genius" },
                    { 10, 6, "Pomeranian", "Mixed", "Black", "Makes bukoo money.", "https://superpetpicturestorage.blob.core.windows.net/productimages/Mani", false, "Mani", 100000m, 1, null, "Can produce cash out of thin-air" }
                });
